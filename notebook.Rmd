...
vein_lifespans_sd
#p-value is 2.746e-10, which is less than 5%. Therefore, the difference is significant
```
...
#p-value is 0.05602, which is greather than 5%. Therefore, we CANNOT reject the null hypothesis. Conclusion, we cannot confirm that there is a difference between vein_lifespans and artery_lifespans
